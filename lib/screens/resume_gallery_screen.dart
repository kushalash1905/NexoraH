...
class _ResumeGalleryScreenState extends State<ResumeGalleryScreen> {
  late List<Candidate> _allCandidates;
  ...
  void initState() {
    super.initState();
    _allCandidates = List.from(dummyCandidates);
  }
          ...
          Positioned(
            ...
            child: CamilleNavBar(
              ...
              peakMatch: _allCandidates.isNotEmpty
                  ? _allCandidates.map((c) => c.matchScore).reduce((a, b) => a > b ? a : b)
                  : 97,
